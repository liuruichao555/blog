...
jQuery.extend(Boxy, {
    ...
    WRAPPER:    "<table cellspacing='0' cellpadding='0' border='0' class='boxy-wrapper'>" +
                "<tr><td class='top-left'></td><td class='boxy-top'></td><td class='top-right'></td></tr>" +
                "<tr><td class='boxy-left'></td><td class='boxy-inner'></td><td class='boxy-right'></td></tr>" +
                "<tr><td class='bottom-left'></td><td class='boxy-bottom'></td><td class='bottom-right'></td></tr>" +
                "</table>",
    ...
    ask: function(question, answers, callback, options) {
        ...
        buttons.html(jQuery.map(answerStrings, function(v) {
			...
			if(v === "查看解析") {
				return "<a target='_blank' href='/question/question_toAnalysis_"+questionId+"_"+sectionId+"_3.html' class='boxy-btn"+btn_index+"'>" + v + "</a>";
			} else {
				return "<input class='boxy-btn"+btn_index+"' type='button' value='" + v + "' />";
			}
        }).join(' '));
